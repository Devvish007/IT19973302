...
public class Payment {
	...
	public Connection connect()
	{
	 ...
	 con= DriverManager.getConnection("Jdbc:mysql://localhost:3307/paymentapi", "root", "root");
	 //For testing
	...
	public String insertPayment(String paymentId,String string, String payDate, String cardHolder, String cardNo,String string2, String expDate)
	{
	 String output = "";
	try
	 {
	 ...
	 preparedStmt.setString(7, string2);
	...
	public String updatePayment(String paymentId,String string, String payDate, String cardHolder, String cardNo,String string2, String expDate)
	{
	String output = "";
	try
	{
	...
	// create a prepared statement
	String query = "UPDATE `payment` SET `paymentID`='"+paymentId+"',`Amount`='"+string+"',`payDate`='"+payDate+"',`cardHolder`='"+cardHolder+"',`cardNo`='"+cardNo+"',`cvv`='"+string2+"',`expDate`='"+expDate+"'";
